...
import { ForgotPassworForm } from "../components/ForgotPassworForm.jsx"
        ...
        <div className="w-full max-w-xl bg-white rounded-xl shadow-lg border border-gray-200 p-6 md:p-10">
            ...
            <div className="text-center mb-6">
                ...
                <p className="text-gray-600 text-base max-w-md mx-auto">
                    {isForgot ? 'Ingresa tu correo electrónico para recuperar tu contraseña' : 'Ingresa a tu cuenta de administrador Kinal Sports'}
                </p>
            </div>
            {isForgot ? (
                <ForgotPassworForm 
