...
import { showError, showSuccess } from "../../../shared/utils/tosts.js";
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t bg-gray-50">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded border bg-white text-sm cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
